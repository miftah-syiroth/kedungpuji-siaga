        ...
        <form method="POST" action="/pregnancies/{{ $pregnancy->id }}">
            ...
            <div class="flex flex-wrap">
                ...
                <label class="block text-sm mx-2" for="mother_weight">
                    ...
                    <input type="number" name="mother_weight" id="mother_weight" min="1" step="any" value="{{ $pregnancy->mother_weight }}" required class="block w-24 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                </label>

                <!-- tb ibu -->
                <label class="block text-sm mx-2" for="mother_height">
                    <span class="text-gray-700 dark:text-gray-400">TB Ibu (cm)</span>
                    <input type="number" name="mother_height" id="mother_height" min="1" step="any" value="{{ $pregnancy->mother_height }}" required class="block w-24 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                </label>
            </div> 
