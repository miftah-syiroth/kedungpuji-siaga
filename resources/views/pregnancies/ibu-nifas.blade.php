<x-app-layout>
    ...
    <div class="px-4 py-2 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <div class="flex flex-col border rounded-md border-gray-300">
            <form action="/ibu-nifas" method="GET">
                <div class="flex flex-row flex-wrap items-end">
                    ...
                    <div class="flex border border-t-0 rounded-md ml-2">
                        <label class="block mx-2 my-2 text-sm">
                            ...
                            <select name="month_childbirth" id="month_childbirth" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                                <option selected disabled hidden>Pilih!</option>
                                @foreach ($months as $month)
                                <option value="{{ $month->id }}">{{ $month->month }}</option>
                                @endforeach
            ...
            <div class="my-2 mx-2 flex">
                <a href="/ibu-nifas" class="px-2 py-1 rounded-md bg-gray-400 text-white dark:bg-gray-200 dark:text-gray-700 hover:bg-gray-600">clear</a>
            </div>
        </div>
