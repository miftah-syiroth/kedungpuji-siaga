            ...
            <form action="/people" method="GET">
                <div class="flex flex-row flex-wrap items-end">
                    ...
                    <label class="block text-sm mx-2 my-2" for="name">
                        ...
                        <input type="text" name="name" id="name" value="{{ request('name') }}" required class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Nama Lengkap"/>
                    </label>
