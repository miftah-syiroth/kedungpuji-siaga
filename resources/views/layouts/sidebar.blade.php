            ...
            <li class="relative px-6 py-3">
                ...
                <template x-if="isKesehatanIbuMenuOpen">
                    <ul
                        ...
                        <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" >
                            <a class="w-full" href="/families/create">Laporan Ibu Hamil</a>
                        </li>
                        <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" >
                            <a class="w-full" href="/couples">Ibu Nifas</a>
                        </li>
                        
                        <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" >
                            <a class="w-full" href="/couples/create">Laporan Ibu Nifas</a>
                        </li>
                    </ul>
                </template>
            </li>
