                ...
                <form method="POST" action="/pregnancies/{{ $pregnancy->id }}/prenatal-classes">
                    ...
                    <div class="border border-b-0 p-2">
                        ...
                        <div class="mx-2 w-80 mt-4">
                            ...
                            <input type="date" name="visited_at" id="visited_at" required class="block mt-1 w-auto border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm">
