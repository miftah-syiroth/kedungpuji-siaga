    ...
    <div class="px-4 py-3 mb-8 bg-white shadow-md dark:bg-gray-800"> 
        ...
        <form method="POST" action="/posyandu/{{ $posyandu->id }}">
            ...
            <div class="flex flex-wrap justify-between text-sm">
                ...
                <a href="/posyandu/{{ $posyandu->id }}" type="submit" class=" bg-purple-400 dark:bg-gray-400 text-white dark:text-gray-800 py-2 px-3 rounded-md hover:bg-purple-700 dark:hover:bg-gray-300 mx-2 my-4">Batal Ubah</a>
            </div>
        </form>
    </div>
