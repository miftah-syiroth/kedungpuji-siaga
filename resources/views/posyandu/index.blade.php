                        ...
                        <tr class="text-gray-700">
                            <td class="px-2 py-1">
                                <div class="flex items-center text-sm">
                                    ...
                                    <div>
                                        <a href="/posyandu/{{ $balita->id }}" class="font-normal text-blue-500 hover:text-blue-800 hover:shadow">{{ $balita->person->name }}</a>
                                    </div>
                                </div>
                            </td>
                            <td class="px-2 py-1 text-sm text-center">
                                {{ $balita->person->rt . '/' . $balita->person->rw }}
                            </td>
                            <td class="px-2 py-1 text-sm text-center">
                                {{-- {{ $person->sex->id == 1 ? 'L' : 'P' }} --}}
                            </td>
