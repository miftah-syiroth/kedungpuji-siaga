    ...
    <div class="px-4 py-3 mb-8 bg-white shadow-md dark:bg-gray-800"> 
        ...
        <form method="POST" action="/anthropometries/{{ $anthropometry->id }}">
            ...
            <div class="p-2">
                <div class="flex flex-wrap mt-4">
                    ...
                    <label class="block text-sm mr-2" for="weight">
                        ...
                        <input type="number" name="weight" id="weight" value="{{ $anthropometry->weight }}" step="any" min="0.5" required class="block w-24 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                    </label>

                    <!-- panjang badan -->
                    <label class="block text-sm mx-2" for="height">
                        <span class="text-gray-700 dark:text-gray-400">Panjang Badan (cm)</span>
                        <input type="number" name="height" id="height" value="{{ $anthropometry->height }}" step="any" min="45" max="120" required class="block w-24 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                    </label>
                ...
                <label class="block text-sm mr-2 mt-4 w-auto" for="visited_at">
                    ...
                    <input type="date" name="visited_at" id="visited_at" value="{{ $anthropometry->visited_at->isoFormat('YYYY-MM-DD') }}" required class="block w-auto mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
            ...
            <div class="flex flex-wrap justify-between text-sm">
                ...
                <a href="/posyandu/{{ $anthropometry->posyandu->id }}" type="submit" class=" bg-purple-400 dark:bg-gray-400 text-white dark:text-gray-800 py-2 px-3 rounded-md hover:bg-purple-700 dark:hover:bg-gray-300 mx-2 my-4">Batal</a>
            </div>
        </form>
    </div>
