            ...
            @csrf
                <div class="flex flex-wrap mt-4">
                    ...
                    <label class="block text-sm mr-2" for="weight">
                        ...
                        <input type="number" name="weight" id="weight" value="{{ old('weight') }}" step="any" min="500" required class="block w-24 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                    </label>

                    <!-- panjang badan -->
                    <label class="block text-sm mx-2" for="height">
                        <span class="text-gray-700 dark:text-gray-400">Panjang Badan (cm)</span>
                        <input type="number" name="height" id="height" value="{{ old('height') }}" step="any" min="10" required class="block w-24 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                    </label>

                    <!-- lingkar kepala -->
                    <label class="block text-sm mx-2" for="head_circumference">
                        <span class="text-gray-700 dark:text-gray-400">Lingkar Kepala (cm)</span>
                        <input type="number" name="head_circumference" id="head_circumference" value="{{ old('head_circumference') }}" step="any" min="10" required class="block w-24 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                    </label>
                </div>
                ...
                <label class="block text-sm mr-2 mt-4 w-auto" for="visited_at">
                    ...
                    <input type="datetime-local" name="visited_at" id="visited_at" value="{{ $current_time->isoFormat('YYYY-MM-DD') }}" required class="block w-auto mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
