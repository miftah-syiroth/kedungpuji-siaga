            ...
            @csrf
                <div class="flex flex-wrap mt-4">
                    ...
                    <label class="block text-sm mx-2" for="height">
                        ...
                        <input type="number" name="height" id="height" value="{{ old('height') }}" step="any" class="block w-24 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                    ...
                    <label class="block text-sm mx-2" for="head_circumference">
                        ...
                        <input type="number" name="head_circumference" id="head_circumference" value="{{ old('head_circumference') }}" step="any" class="block w-24 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                    </label>
                </div>
