            ...
            @method('PUT')
                <div class="flex flex-wrap">
                    <label class="block text-sm mr-2" for="visited_at">
                        ...
                        <input type="datetime-local" name="visited_at" id="visited_at" value="{{ $neonatus->visited_at->isoFormat('YYYY-MM-DDThh:mm') }}" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                    ...
                    <label class="block text-sm mx-2" for="baby_weight">
                        ...
                        <input type="number" name="baby_weight" id="baby_weight" min="1" value="{{ $neonatus->baby_weight }}" class="block w-24 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                    </label>

                    {{-- panjang bayi --}}
                    <label class="block text-sm mx-2" for="baby_lenght">
                        <span class="text-gray-700 dark:text-gray-400">Panjang Badan (cm)</span>
                        <input type="number" name="baby_lenght" id="baby_lenght" value="{{ $neonatus->baby_lenght }}" min="1" class="block w-24 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                    </label>
                    ...
                    <label class="block text-sm mx-2" for="baby_head_circumference">
                        ...
                        <input type="number" name="baby_head_circumference" id="baby_head_circumference" value="{{ $neonatus->baby_head_circumference }}" min="1" class="block w-24 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                    </label>
                </div> 
                ...
                <div class="flex flex-wrap mt-4">
                    <label class="block text-sm mr-2" for="referred_to">
                        ...
                        <input type="text" name="referred_to" id="referred_to" value="{{ $neonatus->referred_to }}" class="block w-auto border-2 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                    </label>

                    <label class="block text-sm mx-2" for="health_worker">
                        <span class="text-gray-700 dark:text-gray-400">Nama Jelas Petugas :</span>
                        <input type="text" name="health_worker" id="health_worker" value="{{ $neonatus->health_worker }}" class="block w-auto border-2 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                    </label>
                </div>
                ...
                <div class="flex flex-wrap justify-between text-sm">
                    ...
                    <a href="/posyandu/{{ $neonatus->posyandu->id }}" type="submit" class=" bg-purple-400 dark:bg-gray-400 text-white dark:text-gray-800 py-2 px-3 rounded-md hover:bg-purple-700 dark:hover:bg-gray-300 mx-2 my-4">Batal</a>
                </div>
        </form>
    </div>
