        ...
        <form method="POST" action="/posyandu/{{ $posyandu->id }}/periode/{{ $periode }}/neonatuses">
            ...
            <div class="flex flex-wrap">
                ...
                <label class="block text-sm mx-2" for="baby_weight">
                    ...
                    <input type="number" name="baby_weight" id="baby_weight" min="1" required class="block w-24 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                </label>

                {{-- panjang bayi --}}
                <label class="block text-sm mx-2" for="baby_lenght">
                    <span class="text-gray-700 dark:text-gray-400">Panjang Badan (cm)</span>
                    <input type="number" name="baby_lenght" id="baby_lenght" min="1" required class="block w-24 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                </label>
                ...
                <label class="block text-sm mx-2" for="baby_head_circumference">
                    ...
                    <input type="number" name="baby_head_circumference" id="baby_head_circumference" min="1" required class="block w-24 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                </label>
            </div> 
            ...
            <div class="flex flex-wrap mt-4">
                <label class="block text-sm mr-2" for="referred_to">
                    ...
                    <input type="text" name="referred_to" id="referred_to" required class="block w-auto border-2 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                </label>

                <!-- baby_weight -->
                <label class="block text-sm mx-2" for="health_worker">
                    <span class="text-gray-700 dark:text-gray-400">Nama Jelas Petugas :</span>
                    <input type="text" name="health_worker" id="health_worker" required class="block w-auto border-2 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                </label>
            </div>
