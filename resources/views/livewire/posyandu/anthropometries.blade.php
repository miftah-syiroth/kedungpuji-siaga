                ...
                <div class="grid gap-2 mb-8 grid-cols-3 mt-4">
                    ...
                    <div class="bg-gray-50 rounded-md border-2">
                        <div class="flex flex-col flex-wrap py-2 px-1">
                            ...
                            <a href="/anthropometries/{{ $data->id }}/edit" class="text-xs text-center rounded-md py-1 bg-green-500 hover:bg-green-700 text-white m-1">edit</a>
                            ...
                            <div class="flex justify-center">
                                <a href="/posyandu/{{ $posyandu->id }}/age-in-month/{{ $i }}/anthropometries/create" class="text-xs rounded-md px-3 py-1 bg-blue-500 hover:bg-blue-700 text-white">input</a>
                            </div>
                            @endif
                        </div>
                    </div>
