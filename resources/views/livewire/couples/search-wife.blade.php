<div class="flex items-center mx-2">
    <label class="block text-sm mr-2" for="name">
        ...
        <input type="text" wire:model="wife_search" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input border-gray-400"/>
    </label>
