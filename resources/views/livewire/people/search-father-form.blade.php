{{-- <div class="mt-4"> --}}
    <div class="flex">
        ...
        <div class="mx-2 items-center">
            ...
            <input type="text" wire:model="father_search_term" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="Cari Ayah Kandung">
